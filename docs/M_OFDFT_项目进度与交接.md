...
| 最近可用提交 | 标签 `s0-handoff-20260805`（包含数值基线、复现协议和最新交接状态） |
...
- 最近可用状态：远端仓库 `main` 标签 `s0-handoff-20260805`；数值证据提交为 `5c6a63423c3c0cca0ac46002fa1df9212b480a6e`，标签 `s0-isolated-smoke-20260805`。

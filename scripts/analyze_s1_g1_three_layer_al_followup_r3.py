...
from parse_s1_g1_three_layer_al_followup_r3 import parse_run as reparse_new_run
...
STRAIN_MAP = {
    "S1-20260810-343": "S1-20260810-204",
    "S1-20260810-344": "S1-20260810-205",
    "S1-20260810-345": "S1-20260810-206",
    "S1-20260810-346": "S1-20260810-207",
}
...
def evaluate_gates(new: dict[str, dict], parent: dict[str, dict], local: dict[str, float], config: dict) -> tuple[dict, list[dict]]:
    ...
    endpoint_specs = {
        "v090": ("S1-20260810-327", "S1-20260810-347", "S1-20260810-348"),
        "v110": ("S1-20260810-328", "S1-20260810-349", "S1-20260810-350"),
    }
...
def build_analysis(project_root: Path, config: dict, new_state: Path, r1_state: Path, continuation_state: Path) -> tuple[dict, list[dict]]:
    ...
    config_sha = sha256_file(project_root / "config/S1_g1_three_layer_al_domain_followup_r3.json")
    manifest_sha = sha256_file(project_root / "config/S1_g1_three_layer_al_domain_followup_r3_manifest.tsv")

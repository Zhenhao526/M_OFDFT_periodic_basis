#!/usr/bin/env python3
"""Validate pre-registration or committed evidence for G1 regeneration-10 R2."""
...
from analyze_s1_g1_regeneration_10_r2 import analyze, write_outputs
    ...
    if args.preregistered:
        ...
        try:
            ...
            actual = [
                ...
                str(project_root / "scripts/launch_s1_g1_regeneration_10_r2.py"),
                "--all",
            ]
            if expected != actual:
        ...
        if not failures and not args.write_completion:
            print(
                ...
                "all scalar, label, electron, field, provenance, and rank proof/ACK gates passed"
            )
    if failures:

...
CONFIG_REL=Path("config/S3_g3_al_iso_v097_optimizer_recovery_r4.json")
MATRIX_REL=Path("config/S3_g3_al_multistructure_matrix_r1.json")
PROTOCOL_REL=Path("docs/S3_G3_AL_ISO_V097_OPTIMIZER_RECOVERY_R4_PROTOCOL.md")
COMMON_REL=Path("scripts/s3_g3_al_iso_v097_optimizer_recovery_common_r4.py")
WORKER_REL=Path("scripts/run_s3_g3_al_iso_v097_optimizer_recovery_worker_r4.py")
RUNNER_REL=Path("scripts/run_s3_g3_al_iso_v097_optimizer_recovery_r4.py")
COLLECTOR_REL=Path("scripts/collect_s3_g3_al_iso_v097_optimizer_recovery_r4.py")
VALIDATOR_REL=Path("scripts/validate_s3_g3_al_iso_v097_optimizer_recovery_r4.py")
TEST_REL=Path("tests/test_s3_g3_al_iso_v097_optimizer_recovery_r4.py")
...
def validate_config(root,c):
 e=execution_config(root);source=source_execution_config(root,e);require(e["schema_version"]==1 and e["protocol_revision"]=="S3-G3-AL-ISO-V097-OPTIMIZER-RECOVERY-20260813-R4","execution schema differs")
 require(e["base_commit"]=="b4176a27f96fbad1a0812403e8a2b170d24c1543","base differs")
 ...
 cases=e["formal_cases"];require([x["experiment_id"] for x in cases]==[f"S3-20260813-{i:03d}" for i in range(381,385)] and len(cases)==4,"case denominator differs")
 ...
 require(e["execution"]=={"execution_worktree_root":"/home/shenwei01/wt_s3_g3_al_iso_v097_optimizer_recovery_r4_20260813","state_root":"/home/shenwei01/.local/state/m_ofdft/s3_g3_al_iso_v097_optimizer_recovery_r4_20260813","analysis_root":"analysis/s3/g3_al_iso_v097_optimizer_recovery_r4_20260813","formal_case_count":4,"no_retry":True,"new_electronic_structure_solver_run_count":4,"child_environment":{"HOME":"/home/shenwei01","PATH":"/usr/bin:/bin","OMP_NUM_THREADS":"1","MKL_NUM_THREADS":"1","OPENBLAS_NUM_THREADS":"1","PYTHONDONTWRITEBYTECODE":"1","PYTHONNOUSERSITE":"1"}},"execution differs")
 for row in cases:
  import numpy as np
...
def _registered_execution_process(comm,tokens):
 names={"run_s3_g3_al_iso_v097_optimizer_recovery_r4.py","run_s3_g3_al_iso_v097_optimizer_recovery_worker_r4.py"}
...
def replay_result(root,c,row,result,density):
 ...
 try:
  ...
  if row["route"]=="coefficient_23_function":replay_recovery_algorithm(root,c,row,result,density)
  return replay

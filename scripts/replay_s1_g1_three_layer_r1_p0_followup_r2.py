#!/usr/bin/env python3
"""Deterministically replay R1 P0 base and enhanced raw gates for follow-up R2."""
...
def replay_r1_p0(run_dir: Path, r1_config: dict, continuation_config: dict) -> tuple[dict, dict, dict]:
    ...
    return base, enhanced, {
        ...
        "enhanced_parser": "replay_s1_g1_three_layer_r1_p0_followup_r2.enhanced_raw_checks",

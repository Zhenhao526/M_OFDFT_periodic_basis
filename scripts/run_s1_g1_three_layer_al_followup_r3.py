#!/usr/bin/env python3
"""Run follow-up R3 once, only after independently closed parent sources exist."""
...
from parse_s1_g1_three_layer_al_followup_r3 import parse_run
...
REGISTERED_CODE = (
    ...
    "config/S1_g1_three_layer_al_domain_followup_r3_manifest.tsv",
    ...
    "scripts/s1_g1_three_layer_al_followup_r3_common.py",
    "scripts/generate_s1_g1_three_layer_al_followup_r3.py",
    "scripts/parse_s1_g1_three_layer_al_followup_r3.py",
    ...
    "scripts/analyze_s1_g1_three_layer_al_followup_r3.py",
    "scripts/validate_s1_g1_three_layer_al_followup_r3.py",
...
def replay_continuation_al_raw(run_dir: Path, stored: dict, config: dict, continuation_spec: dict) -> dict:
    ...
    return {
        "parser": "parse_s1_g1_three_layer_al_followup_r3.parse_run",
...
def binding_command(project_root: Path, config: dict, evidence_dir: Path, *, mode: str) -> list[str]:
    ...
    command = [
        ...
        str(project_root / "scripts/s1_g1_three_layer_al_followup_r3_rank_wrapper.py"),
...
def write_failure(run_dir: Path, experiment_id: str, stage: str, message: str, return_code: int | None) -> None:
    ...
    atomic_write(path, canonical_json_bytes({
        "schema_version": 1, "protocol_revision": "S1-G1-THREE-LAYER-AL-DOMAIN-FOLLOWUP-20260810-R3",

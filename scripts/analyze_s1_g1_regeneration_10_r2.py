...
def analyze(
    ...
    expected_commands = [
        [
            ...
            str(project_root / "scripts/run_s1_g1_regeneration_case_r2.py"),
            "--case-id", case_id,
        ]
    ...
    hard_gates = {
        ...
        "all_runtime_rank_proof_ack_gates": all(
            result["rank_barrier_accepted"] for result in case_results.values()
        ),
...
def readme(summary: dict) -> bytes:
    ...
    text = f"""# G1 fixed ten-case single-command regeneration R2

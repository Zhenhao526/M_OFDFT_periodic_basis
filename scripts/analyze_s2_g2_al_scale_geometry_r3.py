...
from s2_g2_al_scale_geometry_common_r3 import build_analysis, git, load_config, render_outputs, require
...
def main() -> int:
    ...
    print(json.dumps({
        ...
        "geometry_cases": analysis["summary"]["geometry_case_count"],
        "scale_cases": analysis["summary"]["scale_case_count"],

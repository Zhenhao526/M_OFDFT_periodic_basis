...
class S1G1ThermodynamicLabelAuditR3GeneratorTest(unittest.TestCase):
    @classmethod
    ...
    def test_namespace_is_exact_all_new_forty(self) -> None:
        ...
        self.assertEqual(
            tuple(GENERATOR.NEW_TO_LOGICAL), GENERATOR.R3_AUDIT_IDS
        )
        self.assertEqual(
        ...
        self.assertEqual(len(GENERATOR.R3_AUDIT_IDS), 40)
        ...
        self.assertEqual(
            ...
            set(GENERATOR.R3_AUDIT_IDS),
        )
        self.assertEqual(GENERATOR.EXECUTION_ORDER, GENERATOR.R3_AUDIT_IDS)
    ...
    def test_plan_preserves_logical_slots_and_uses_p1_then_p2(self) -> None:
        ...
        self.assertEqual(
            by_logical["S1-20260806-024"]["evidence_origin"], "r3_executed"
        )
        self.assertEqual(
            by_logical["S1-20260806-034"]["evidence_origin"], "r3_executed"
        )
        self.assertEqual(
    ...
    def test_r2_stopped_bridge_is_immutable_and_never_reused(self) -> None:
        ...
        self.assertTrue(bridge["r3_reuse_forbidden"])
    ...
    def test_prepare_copies_all_scientific_and_runtime_gates_from_r1(self) -> None:
        ...
        self.assertEqual(config["registered_experiment_ids"], list(GENERATOR.R3_AUDIT_IDS))

...
import analyze_s1_g1_thermodynamic_label_audit_r4 as ANALYZER  # noqa: E402
import validate_s1_g1_thermodynamic_label_audit_r4 as VALIDATOR  # noqa: E402


class S1G1ThermodynamicLabelAuditR4AnalysisTest(unittest.TestCase):
    ...
    def test_complete_mocked_partition_is_accepted(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(summary["accepted_reused_r1_count"], 0)
            self.assertEqual(summary["excluded_historical_r1_count"], 10)
            self.assertEqual(summary["accepted_new_r4_count"], 40)

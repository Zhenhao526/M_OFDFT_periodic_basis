...
import analyze_s1_g1_thermodynamic_label_audit_r3 as ANALYZER  # noqa: E402
import validate_s1_g1_thermodynamic_label_audit_r3 as VALIDATOR  # noqa: E402


class S1G1ThermodynamicLabelAuditR3AnalysisTest(unittest.TestCase):
    ...
    def test_complete_mocked_partition_is_accepted(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(summary["accepted_new_r3_count"], 40)
